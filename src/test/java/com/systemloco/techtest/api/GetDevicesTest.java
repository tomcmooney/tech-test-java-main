...
public class GetDevicesTest {
        ...
        @Test
        public void whenGetDevices_returnsOK_withTwoDevicesInDevicesListSortedByLastReportedDescending() {
                // Given a devices list with one device in it
                ...
                template.getCollection("device").insertOne(new Document(Map.of(
                                ...
                                "lastReported", Date.from(Instant.parse("2025-01-03T00:00:00Z")),
                                "location", Map.of(
                                                "lat", -54.0,
                                                "lon", -2.7,
                                                "cep", 200.0),
