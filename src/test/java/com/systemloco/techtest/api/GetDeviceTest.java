...
public class GetDeviceTest {
    ...
    @Test public void whenDeviceExists_returnsOk_withDeviceDetails() {
        RestAssured
                .given()
                ...
                .body(
                        ...
                        "profile.name", is("test profile name"),
                        "profile.description", is("test profile description"),
                        "location", is(Map.of(
                                "lat", -54.0F,
                                "lon", -2.7F,
                                "cep", 200.0F
    ...
    @Test public void whenDeviceDoesNotExist_returnsNotFound() {
        RestAssured
                .given()
