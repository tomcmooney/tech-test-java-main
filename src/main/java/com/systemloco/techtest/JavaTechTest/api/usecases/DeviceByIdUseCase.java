...
public class DeviceByIdUseCase {
    @NotNull private final DeviceByIdRepository byId;

    @Nullable public Response invoke(
    ...
    public record Response(
        ...
        @NotNull public static Response fromData(
        ...
        public record Model(
            ...
            @NotNull public static Model fromModelName(
        ...
        public record Profile(
            ...
            @Nullable public static Profile fromData(
        ...
        public record Location(
            ...
            @Nullable public static Location fromData(
        ...
        public record Sensors(
            ...
            @Nullable public static Sensors fromData(
            ...
            public record Vector(
                ...
                @Nullable public static Vector fromData(
